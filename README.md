...
面向“今晚，和音乐一起睡个好觉”课题的声音疗愈花园 Web 3D Demo。
...
这是基于现有 HTML/Three.js Demo 的迭代项目，不需要 Android 容器或真实后端。具体模块负责人、分支命名和验收方式见 [`团队分工.md`](./团队分工.md)。所有功能先在自己的分支开发，通过 Pull Request 合并到 `main`，不要直接改动稳定演示版。
