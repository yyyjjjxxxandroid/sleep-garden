...
class GardenWorld {
  ...
  update(now){
    ...
    this.controls.target.x=T.MathUtils.clamp(this.controls.target.x,-20,20);this.controls.target.z=T.MathUtils.clamp(this.controls.target.z,-20,20);this.controls.target.y=T.MathUtils.clamp(this.controls.target.y,.5,5);this.controls.update();this.updateGrowth();this.renderer.render(this.scene,this.camera);
...
window.GardenWorld=GardenWorld;
